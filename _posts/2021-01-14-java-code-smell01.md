...
* 이처럼 함수 자체를 반환하는것이 어떤 의미가 있을지, 어떻게 활용할 수 있을지는 코드 스멜 없애기 시리즈를 진행하며 천천히 알아가보겠습니다. 
...
* 카카오 헤어샵 개발팀은 앞으로 기회가 될때마다 코드 스멜 없애기를 공유해 드리려고 합니다. 다음 시리즈도 기대해주세요 :) 
